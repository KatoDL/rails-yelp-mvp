...
viavia = { name: "Via Via", address: "Naamsesteenweg 63 3000 Leuven", category: "belgian" }
epicure = { name: "Epicure", address: "75008 Paris", category: "french" }
stordeur = {name: "Stordeur", address: "Vaart 3000 Leuven", category: "belgian"}


[ dishoom, pizza_east, viavia, epicure, stordeur ].each do |attributes|
